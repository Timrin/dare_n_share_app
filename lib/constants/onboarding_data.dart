...
//List of the onboarding page body text
  static const List<String> textBodies = [
    ...
    """A Dare is a fun and friendly, yet competitive way for you and your friends to improve your habits. The app will help you keep track of how you're doing and how your co-competitor is doing.""",
    """Dares don't go on forever, when a dares is over a winner is determined! Although winning is fun, the main objective is to improve yourself and your habits, if you succeed in this you are winner no matter what!"""
  ];
}
